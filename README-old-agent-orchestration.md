...
## Example Project: Love Invaders 💘

This repository includes a complete implementation of "Love Invaders" - a Valentine's Day themed Space Invaders clone built using HTML5 Canvas and vanilla JavaScript.

### Game Features
- ✅ Complete win/lose conditions and level progression
- ✅ Dynamic difficulty scaling (speed and fire rate increase)
- ✅ High score persistence with localStorage
- ✅ Lives system with invincibility periods
- ✅ Full HUD with score, lives, and level display
- ✅ Enemy invasion detection
...
4. Use Arrow Keys or A/D to move
5. Press SPACE to shoot

### Game Documentation
- **[Quick Reference Guide](docs/quick-reference.md)** - How to play, controls, tips & strategy
- **[Implementation Complete](IMPLEMENTATION-COMPLETE.md)** - Full technical implementation summary
- **[Game Logic Details](docs/game-logic-complete.md)** - Detailed system documentation
- **[Testing Guide](docs/game-logic-testing.md)** - Comprehensive test cases and checklist
...
│   ├── collisions.js   # Win/lose conditions
